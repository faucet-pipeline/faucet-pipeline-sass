...
module.exports = (rootDir, { config, fingerprint, minify }) => {
  ...
  let bundles = translateBundlerConfigs(config.bundles, { targetDir, rootDir, fingerprint, minify })
...
function translateBundlerConfigs (bundleConfigs, { targetDir, rootDir, fingerprint, minify }) {
